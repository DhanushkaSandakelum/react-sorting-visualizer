    ...
    if (enableVisualization) {
        ...
        for (let i = 0; i < animList.length; i++) {
            setTimeout(() => {
                ...
                switch (animList[i].effect) {
                    case "compare":
                        bar1Style.backgroundColor = BAR_COLOR_COMPARE;
                        bar2Style.backgroundColor = BAR_COLOR_COMPARE;
                        break;

                    case "found":
                        bar1Style.backgroundColor = BAR_COLOR_FOUND;
                        bar2Style.backgroundColor = BAR_COLOR_FOUND;
                        break;

                    case "swap":
                        bar1Style.backgroundColor = BAR_COLOR_SWAP;
                        bar2Style.backgroundColor = BAR_COLOR_SWAP;
        ...
        for (let i = 0; i < animList.length; i++) {
            setTimeout(() => {
                const bar1Style = arrayBars[animList[i].bar1.idx].style;
                const bar2Style = arrayBars[animList[i].bar2.idx].style;
                bar1Style.backgroundColor = BAR_COLOR_VERIFY;
                bar2Style.backgroundColor = BAR_COLOR_VERIFY;
